...
var AdalClient = /** @class */function (_super) {
    (0, _tslib.__extends)(AdalClient, _super);
    /**
    ...
    AdalClient.fromSPFxContext = function (spfxContext, cliendId) {
        if (cliendId === void 0) {
            cliendId = "c58637bb-e2e1-4312-8a00-04b5ffcd3403";
        }
    ...
    AdalClient.prototype.ensureAuthContext = function () {
        ...
        return new Promise(function (resolve) {
            if (AdalClient._authContext === null) {
                AdalClient._authContext = (0, _adalAngular.inject)({
...
function beta(message) {
    if (message === void 0) {
        message = "This feature is flagged as beta and is subject to change.";
    }
    return function (target, propertyKey, descriptor) {
        var method = descriptor.value;
        descriptor.value = function () {
...
var UrlException = /** @class */function (_super) {
    (0, _tslib.__extends)(UrlException, _super);
    function UrlException(msg) {
        var _this = _super.call(this, msg) || this;
        _this.name = "UrlException";
        _logging.Logger.log({ data: {}, level: 3 /* Error */, message: "[" + _this.name + "]::" + _this.message });
        return _this;
    }
    return UrlException;
}(Error);
...
var PnPClientStorageWrapper = /** @class */function () {
    ...
    function PnPClientStorageWrapper(store, defaultTimeoutMinutes) {
        ...
        if (RuntimeConfig.enableCacheExpiration) {
            _logging.Logger.write("Enabling cache expiration.", 1 /* Info */);
    ...
    PnPClientStorageWrapper.prototype.get = function (key) {
        ...
        if (new Date(persistable.expiration) <= new Date()) {
            _logging.Logger.write("Removing item with key '" + key + "' from cache due to expiration.", 1 /* Info */);
            this.delete(key);
            return null;
        } else {
    ...
    PnPClientStorageWrapper.prototype.cacheExpirationHandler = function () {
        var _this = this;
        _logging.Logger.write("Called cache expiration handler.", 0 /* Verbose */);
...
},{"tslib":295,"adal-angular":310,"@pnp/logging":296}],298:[function(require,module,exports) {
'use strict';
...
var CachingOptions = /** @class */function () {
    function CachingOptions(key) {
        this.key = key;
        this.expiration = (0, _common.dateAdd)(new Date(), "second", _common.RuntimeConfig.defaultCachingTimeoutSeconds);
        this.storeName = _common.RuntimeConfig.defaultCachingStore;
    }
...
var ProcessHttpClientResponseException = /** @class */function (_super) {
    (0, _tslib.__extends)(ProcessHttpClientResponseException, _super);
    function ProcessHttpClientResponseException(status, statusText, data) {
        ...
        _logging.Logger.log({ data: _this.data, level: 3 /* Error */, message: _this.message });
        return _this;
    }
...
var ODataDefaultParser = /** @class */function (_super) {
    (0, _tslib.__extends)(ODataDefaultParser, _super);
...
function pipe(context) {
    if (context.pipeline.length < 1) {
        _logging.Logger.write("[" + context.requestId + "] (" + new Date().getTime() + ") Request pipeline contains no methods!", 2 /* Warning */);
    }
    ...
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function () {
            ...
            if (!alwaysRun && args.length > 0 && args[0].hasOwnProperty("hasResult") && args[0].hasResult) {
                _logging.Logger.write("[" + args[0].requestId + "] (" + new Date().getTime() + ") Skipping request pipeline method " + propertyKey + ", existing result in pipeline.", 0 /* Verbose */);
                return Promise.resolve(args[0]);
            }
            // apply the tagged method
            _logging.Logger.write("[" + args[0].requestId + "] (" + new Date().getTime() + ") Calling request pipeline method " + propertyKey + ".", 0 /* Verbose */);
...
var PipelineMethods = /** @class */function () {
    ...
    PipelineMethods.logStart = function (context) {
        return new Promise(function (resolve) {
            _logging.Logger.log({
                data: _logging.Logger.activeLogLevel === 1 /* Info */ ? {} : context,
                level: 1 /* Info */
    ...
    PipelineMethods.caching = function (context) {
        return new Promise(function (resolve) {
            ...
            if (context.verb === "GET" && context.isCached) {
                _logging.Logger.write("[" + context.requestId + "] (" + new Date().getTime() + ") Caching is enabled for request, checking cache...", 1 /* Info */);
                var cacheOptions = new CachingOptions(context.requestAbsoluteUrl.toLowerCase());
                if (typeof context.cachingOptions !== "undefined") {
                    cacheOptions = (0, _common.extend)(cacheOptions, context.cachingOptions);
                }
                ...
                if (cacheOptions.store !== null) {
                    ...
                    if (data !== null) {
                        ...
                        _logging.Logger.log({
                            data: _logging.Logger.activeLogLevel === 1 /* Info */ ? {} : data,
                            level: 1 /* Info */
                ...
                _logging.Logger.write("[" + context.requestId + "] (" + new Date().getTime() + ") Value not found in cache.", 1 /* Info */);
    ...
    PipelineMethods.send = function (context) {
        return new Promise(function (resolve, reject) {
            ...
            if (context.isBatched) {
                ...
                _logging.Logger.write("[" + context.requestId + "] (" + new Date().getTime() + ") Batching request in batch " + context.batch.batchId + ".", 1 /* Info */);
                // we set the result as the promise which will be resolved by the batch's execution
                resolve(setResult(context, p));
            } else {
                _logging.Logger.write("[" + context.requestId + "] (" + new Date().getTime() + ") Sending request.", 1 /* Info */);
                // we are not part of a batch, so proceed as normal
                var client = context.clientFactory();
                var opts = (0, _common.extend)(context.options || {}, { method: context.verb });
...
var AlreadyInBatchException = /** @class */function (_super) {
    (0, _tslib.__extends)(AlreadyInBatchException, _super);
...
var Queryable = /** @class */function () {
    function Queryable() {
        this._query = new _common.Dictionary();
        this._options = {};
        this._url = "";
        this._parentUrl = "";
    ...
    */
    ...
    Queryable.prototype.configure = function (options) {
        (0, _common.mergeOptions)(this._options, options);
        return this;
    };
    /**
    ...
    Queryable.prototype.configureFrom = function (o) {
        (0, _common.mergeOptions)(this._options, o._options);
        return this;
    };
    /**
    ...
    Queryable.prototype.getCore = function (parser, options) {
        ...
        return this.toRequestContext("GET", options, parser, getDefaultPipeline()).then(function (context) {
            return pipe(context);
        });
    };
    Queryable.prototype.postCore = function (options, parser) {
        ...
        return this.toRequestContext("POST", options, parser, getDefaultPipeline()).then(function (context) {
            return pipe(context);
        });
    };
    Queryable.prototype.patchCore = function (options, parser) {
        ...
        return this.toRequestContext("PATCH", options, parser, getDefaultPipeline()).then(function (context) {
            return pipe(context);
        });
    };
    Queryable.prototype.deleteCore = function (options, parser) {
        ...
        return this.toRequestContext("DELETE", options, parser, getDefaultPipeline()).then(function (context) {
            return pipe(context);
        });
    };
    Queryable.prototype.putCore = function (options, parser) {
        ...
        return this.toRequestContext("PUT", options, parser, getDefaultPipeline()).then(function (context) {
            return pipe(context);
        });
    };
    /**
    ...
    Queryable.prototype.append = function (pathPart) {
        this._url = (0, _common.combinePaths)(this._url, pathPart);
    };
    ...
    Queryable.prototype.extend = function (parent, path) {
        ...
        this._url = (0, _common.combinePaths)(this._parentUrl, path);
        this.configureFrom(parent);
    };
    return Queryable;
}();
var ODataQueryable = /** @class */function (_super) {
    (0, _tslib.__extends)(ODataQueryable, _super);
    ...
    */
    ...
    Object.defineProperty(ODataQueryable.prototype, "hasBatch", {
         ...
         */
        get: function () {
            return (0, _common.objectDefinedNotNull)(this._batch);
        },
        enumerable: true,
        configurable: true
    });
...
},{"@pnp/common":297,"tslib":295,"@pnp/logging":296}],36:[function(require,module,exports) {
var global = (1,eval)("this");
'use strict';
...
var SPBatchParseException = /** @class */function (_super) {
    (0, _tslib.__extends)(SPBatchParseException, _super);
...
var SPODataIdException = /** @class */function (_super) {
    (0, _tslib.__extends)(SPODataIdException, _super);
...
var MaxCommentLengthException = /** @class */function (_super) {
    (0, _tslib.__extends)(MaxCommentLengthException, _super);
...
var NotSupportedInBatchException = /** @class */function (_super) {
    (0, _tslib.__extends)(NotSupportedInBatchException, _super);
...
var APIUrlException = /** @class */function (_super) {
    (0, _tslib.__extends)(APIUrlException, _super);
...
function spGetEntityUrl(entity) {
    if (entity.hasOwnProperty("odata.metadata") && entity.hasOwnProperty("odata.editLink")) {
        ...
        return (0, _common.combinePaths)(extractWebUrl(entity["odata.metadata"]), "_api", entity["odata.editLink"]);
        ...
        _logging.Logger.write("No uri information found in ODataEntity parsing, chaining will fail for this object.", 2 /* Warning */);
        return "";
    }
}
...
function setup(config) {
    _common.RuntimeConfig.extend(config);
}
var SPRuntimeConfigImpl = /** @class */function () {
    ...
    Object.defineProperty(SPRuntimeConfigImpl.prototype, "baseUrl", {
        get: function () {
            ...
            if (_common.RuntimeConfig.spfxContext !== null) {
...
var digests = new _common.Dictionary();
var DigestCache = /** @class */function () {
    ...
    DigestCache.prototype.getDigest = function (webUrl) {
        ...
        var url = (0, _common.combinePaths)(webUrl, "/_api/contextinfo");
        var headers = {
        ...
        return this._httpClient.fetchRaw(url, {
            ...
            headers: (0, _common.extend)(headers, SPRuntimeConfig.headers, true),
            method: "POST"
        }).then(function (response) {
            var parser = new _odata.ODataDefaultParser();
...
var SPHttpClient = /** @class */function () {
    ...
    SPHttpClient.prototype.fetch = function (url, options) {
        ...
        var opts = (0, _common.extend)(options, { cache: "no-cache", credentials: "same-origin" }, true);
        var headers = new Headers();
        // first we add the global headers so they can be overwritten by any passed in locally to this call
        (0, _common.mergeHeaders)(headers, SPRuntimeConfig.headers);
        // second we add the local options so we can overwrite the globals
        (0, _common.mergeHeaders)(headers, options.headers);
        ...
        opts = (0, _common.extend)(opts, { headers: headers });
    ...
    SPHttpClient.prototype.fetchRaw = function (url, options) {
        ...
        options = (0, _common.extend)(options, { headers: rawHeaders });
    ...
    SPHttpClient.prototype.get = function (url, options) {
        ...
        var opts = (0, _common.extend)(options, { method: "GET" });
    ...
    SPHttpClient.prototype.post = function (url, options) {
        ...
        var opts = (0, _common.extend)(options, { method: "POST" });
        return this.fetch(url, opts);
    };
    SPHttpClient.prototype.patch = function (url, options) {
        ...
        var opts = (0, _common.extend)(options, { method: "PATCH" });
        return this.fetch(url, opts);
    };
    SPHttpClient.prototype.delete = function (url, options) {
        ...
        var opts = (0, _common.extend)(options, { method: "DELETE" });
        return this.fetch(url, opts);
    };
    return SPHttpClient;
}();
...
function toAbsoluteUrl(candidateUrl) {
    return new Promise(function (resolve) {
        ...
        if (SPRuntimeConfig.baseUrl !== null) {
            ...
            return resolve((0, _common.combinePaths)(SPRuntimeConfig.baseUrl, candidateUrl));
        }
        if (typeof global._spPageContextInfo !== "undefined") {
            // operating in classic pages
            if (global._spPageContextInfo.hasOwnProperty("webAbsoluteUrl")) {
                return resolve((0, _common.combinePaths)(global._spPageContextInfo.webAbsoluteUrl, candidateUrl));
            } else if (global._spPageContextInfo.hasOwnProperty("webServerRelativeUrl")) {
                return resolve((0, _common.combinePaths)(global._spPageContextInfo.webServerRelativeUrl, candidateUrl));
            }
        }
        ...
        if (typeof global.location !== "undefined") {
            ...
            ["/_layouts/", "/siteassets/"].forEach(function (s) {
                ...
                if (index > 0) {
                    return resolve((0, _common.combinePaths)(baseUrl_1.substr(0, index), candidateUrl));
                }
            });
        }
        return resolve(candidateUrl);
...
var SharePointQueryable = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryable, _super);
    /**
    ...
    function SharePointQueryable(baseUrl, path) {
        ...
        if (typeof baseUrl === "string") {
            ...
            var urlStr = baseUrl;
            if ((0, _common.isUrlAbsolute)(urlStr) || urlStr.lastIndexOf("/") < 0) {
                _this._parentUrl = urlStr;
                _this._url = (0, _common.combinePaths)(urlStr, path);
            } else if (urlStr.lastIndexOf("/") > urlStr.lastIndexOf("(")) {
                // .../items(19)/fields
                var index = urlStr.lastIndexOf("/");
                _this._parentUrl = urlStr.slice(0, index);
                path = (0, _common.combinePaths)(urlStr.slice(index), path);
                _this._url = (0, _common.combinePaths)(_this._parentUrl, path);
            } else {
                // .../items(19)
                var index = urlStr.lastIndexOf("(");
                _this._parentUrl = urlStr.slice(0, index);
    ...
    SharePointQueryable.prototype.as = function (factory) {
        ...
        return (0, _common.extend)(o, this, true);
    };
    /**
    ...
    SharePointQueryable.prototype.toUrlAndQuery = function () {
        var aliasedParams = new _common.Dictionary();
        var url = this.toUrl().replace(/'!(@.*?)::(.*?)'/ig, function (match, labelName, value) {
            _logging.Logger.write("Rewriting aliased parameter from match " + match + " to label: " + labelName + " value: " + value, 0 /* Verbose */);
    ...
    SharePointQueryable.prototype.toRequestContext = function (verb, options, parser, pipeline) {
        ...
        return toAbsoluteUrl(this.toUrlAndQuery()).then(function (url) {
            (0, _common.mergeOptions)(options, _this._options);
...
}(_odata.ODataQueryable);
/**
 * Represents a REST collection which can be filtered, paged, and selected
 *
 */
var SharePointQueryableCollection = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableCollection, _super);
    ...
    SharePointQueryableCollection.prototype.orderBy = function (orderBy, ascending) {
        ...
        var query = this._query.getKeys().filter(function (k) {
            return k === "$orderby";
        }).map(function (k) {
            return _this._query.get(k);
        });
...
var SharePointQueryableInstance = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableInstance, _super);
...
var SiteUsers = /** @class */function (_super) {
    (0, _tslib.__extends)(SiteUsers, _super);
    /**
...
var SiteUser = /** @class */function (_super) {
    (0, _tslib.__extends)(SiteUser, _super);
    function SiteUser() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    */
    SiteUser.prototype.update = function (properties) {
        var _this = this;
        var postBody = (0, _common.extend)({ "__metadata": { "type": "SP.User" } }, properties);
...
var CurrentUser = /** @class */function (_super) {
    (0, _tslib.__extends)(CurrentUser, _super);
...
var SiteGroups = /** @class */function (_super) {
    (0, _tslib.__extends)(SiteGroups, _super);
    /**
    ...
    SiteGroups.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify((0, _common.extend)({ "__metadata": { "type": "SP.Group" } }, properties));
...
var SiteGroup = /** @class */function (_super) {
    (0, _tslib.__extends)(SiteGroup, _super);
    function SiteGroup() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    */
    ...
    SiteGroup.prototype.update = function (properties) {
        var _this = this;
        var postBody = (0, _common.extend)({ "__metadata": { "type": "SP.Group" } }, properties);
        return this.postCore({
            body: JSON.stringify(postBody),
            headers: {
                "X-HTTP-Method": "MERGE"
...
var RoleAssignments = /** @class */function (_super) {
    (0, _tslib.__extends)(RoleAssignments, _super);
    /**
...
var RoleAssignment = /** @class */function (_super) {
    (0, _tslib.__extends)(RoleAssignment, _super);
...
var RoleDefinitions = /** @class */function (_super) {
    (0, _tslib.__extends)(RoleDefinitions, _super);
    /**
    ...
    RoleDefinitions.prototype.add = function (name, description, order, basePermissions) {
        ...
        var postBody = JSON.stringify({
            BasePermissions: (0, _common.extend)({ __metadata: { type: "SP.BasePermissions" } }, basePermissions),
...
var RoleDefinition = /** @class */function (_super) {
    (0, _tslib.__extends)(RoleDefinition, _super);
    ...
    RoleDefinition.prototype.update = function (properties) {
        ...
        if (typeof properties.hasOwnProperty("BasePermissions") !== "undefined") {
            properties["BasePermissions"] = (0, _common.extend)({ __metadata: { type: "SP.BasePermissions" } }, properties["BasePermissions"]);
        }
        var postBody = JSON.stringify((0, _common.extend)({
            "__metadata": { "type": "SP.RoleDefinition" }
        }, properties));
        return this.postCore({
            body: postBody,
...
var RoleDefinitionBindings = /** @class */function (_super) {
    (0, _tslib.__extends)(RoleDefinitionBindings, _super);
    /**
...
var SharePointQueryableSecurable = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableSecurable, _super);
...
var SharePointQueryableShareable = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableShareable, _super);
    ...
    SharePointQueryableShareable.prototype.shareWith = function (loginNames, role, requireSignin, propagateAcl, emailData) {
        ...
        return w.select("Id").filter("RoleTypeKind eq " + roleFilter).get().then(function (def) {
            ...
            if (typeof emailData !== "undefined") {
                postBody = (0, _common.extend)(postBody, {
    ...
    SharePointQueryableShareable.prototype.shareObject = function (options, bypass) {
        ...
        options = (0, _common.extend)(options, {
            group: null,
        ...
        if (typeof group !== "undefined" && group !== null) {
            switch (group) {
                case RoleType.Contributor:
                    ...
                    return memberGroup.select("Id").get().then(function (g) {
                        return "group: " + g.Id;
                    });
                ...
                case RoleType.Guest:
                    ...
                    return visitorGroup.select("Id").get().then(function (g) {
                        return "group: " + g.Id;
                    });
                default:
...
var SharePointQueryableShareableWeb = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableShareableWeb, _super);
    ...
    SharePointQueryableShareableWeb.prototype.shareWith = function (loginNames, role, emailData) {
        ...
        return web.get().then(function (url) {
            dependency();
            return _this.shareObject((0, _common.combinePaths)(url, "/_layouts/15/aclinv.aspx?forSharing=1&mbypass=1"), loginNames, role, emailData);
        });
    };
    /**
...
var SharePointQueryableShareableItem = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableShareableItem, _super);
    ...
    SharePointQueryableShareableItem.prototype.getShareLink = function (kind, expiration) {
        if (kind === void 0) {
            kind = SharingLinkKind.OrganizationView;
        }
        if (expiration === void 0) {
            expiration = null;
        }
...
var FileFolderShared = /** @class */function (_super) {
    (0, _tslib.__extends)(FileFolderShared, _super);
...
var SharePointQueryableShareableFile = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableShareableFile, _super);
...
var SharePointQueryableShareableFolder = /** @class */function (_super) {
    (0, _tslib.__extends)(SharePointQueryableShareableFolder, _super);
...
var LimitedWebPartManager = /** @class */function (_super) {
    (0, _tslib.__extends)(LimitedWebPartManager, _super);
...
var WebPartDefinitions = /** @class */function (_super) {
    (0, _tslib.__extends)(WebPartDefinitions, _super);
...
var WebPartDefinition = /** @class */function (_super) {
    (0, _tslib.__extends)(WebPartDefinition, _super);
...
var WebPart = /** @class */function (_super) {
    (0, _tslib.__extends)(WebPart, _super);
    /**
...
var Folders = /** @class */function (_super) {
    (0, _tslib.__extends)(Folders, _super);
    /**
...
var Folder = /** @class */function (_super) {
    (0, _tslib.__extends)(Folder, _super);
    function Folder() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    */
    ...
    Folder.prototype.getItem = function () {
        ...
        return q.select.apply(q, selects).get().then(function (d) {
            return (0, _common.extend)(new Item(spGetEntityUrl(d)), d);
        });
    };
    return Folder;
...
var ContentTypes = /** @class */function (_super) {
    (0, _tslib.__extends)(ContentTypes, _super);
    /**
...
var ContentType = /** @class */function (_super) {
    (0, _tslib.__extends)(ContentType, _super);
...
var FieldLinks = /** @class */function (_super) {
    (0, _tslib.__extends)(FieldLinks, _super);
    /**
...
var FieldLink = /** @class */function (_super) {
    (0, _tslib.__extends)(FieldLink, _super);
    function FieldLink() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return FieldLink;
...
var AttachmentFiles = /** @class */function (_super) {
    (0, _tslib.__extends)(AttachmentFiles, _super);
    /**
...
var AttachmentFile = /** @class */function (_super) {
    (0, _tslib.__extends)(AttachmentFile, _super);
...
var Views = /** @class */function (_super) {
    (0, _tslib.__extends)(Views, _super);
    /**
...
var ViewFields = /** @class */function (_super) {
    (0, _tslib.__extends)(ViewFields, _super);
...
var Fields = /** @class */function (_super) {
    (0, _tslib.__extends)(Fields, _super);
    /**
    ...
    Fields.prototype.addText = function (title, maxLength, properties) {
        ...
        return this.add(title, "SP.FieldText", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addCalculated = function (title, formula, dateFormat, outputType, properties) {
        ...
        return this.add(title, "SP.FieldCalculated", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addDateTime = function (title, displayFormat, calendarType, friendlyDisplayFormat, properties) {
        ...
        return this.add(title, "SP.FieldDateTime", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addNumber = function (title, minValue, maxValue, properties) {
        ...
        if (typeof minValue !== "undefined") {
            props = (0, _common.extend)({ MinimumValue: minValue }, props);
        }
        if (typeof maxValue !== "undefined") {
            props = (0, _common.extend)({ MaximumValue: maxValue }, props);
        }
        return this.add(title, "SP.FieldNumber", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addCurrency = function (title, minValue, maxValue, currencyLocalId, properties) {
        ...
        return this.add(title, "SP.FieldCurrency", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultilineText = function (title, numberOfLines, richText, restrictedMode, appendOnly, allowHyperlink, properties) {
        ...
        return this.add(title, "SP.FieldMultiLineText", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addUrl = function (title, displayFormat, properties) {
        ...
        return this.add(title, "SP.FieldUrl", (0, _common.extend)(props, properties));
    };
    ...
    */
    Fields.prototype.addUser = function (title, selectionMode, properties) {
        ...
        return this.add(title, "SP.FieldUser", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addChoice = function (title, choices, format, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldChoice", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addMultiChoice = function (title, choices, fillIn, properties) {
        ...
        return this.add(title, "SP.FieldMultiChoice", (0, _common.extend)(props, properties));
    };
    /**
    ...
    Fields.prototype.addBoolean = function (title, properties) {
        ...
        return this.add(title, "SP.Field", (0, _common.extend)(props, properties));
    };
    return Fields;
}(SharePointQueryableCollection);
/**
...
var Field = /** @class */function (_super) {
    (0, _tslib.__extends)(Field, _super);
    function Field() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
...
var Forms = /** @class */function (_super) {
    (0, _tslib.__extends)(Forms, _super);
    /**
     * Creates a new instance of the Fields class
     *
     * @param baseUrl The url or SharePointQueryable which forms the parent of this fields collection
...
var Form = /** @class */function (_super) {
    (0, _tslib.__extends)(Form, _super);
    function Form() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return Form;
...
var Subscriptions = /** @class */function (_super) {
    (0, _tslib.__extends)(Subscriptions, _super);
    /**
...
var UserCustomActions = /** @class */function (_super) {
    (0, _tslib.__extends)(UserCustomActions, _super);
    /**
    ...
    UserCustomActions.prototype.add = function (properties) {
        var _this = this;
        var postBody = JSON.stringify((0, _common.extend)({ __metadata: { "type": "SP.UserCustomAction" } }, properties));
        return this.postCore({ body: postBody }).then(function (data) {
            return {
...
var UserCustomAction = /** @class */function (_super) {
    (0, _tslib.__extends)(UserCustomAction, _super);
...
var Lists = /** @class */function (_super) {
    (0, _tslib.__extends)(Lists, _super);
    /**
    ...
    Lists.prototype.add = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        var addSettings = (0, _common.extend)({
    ...
    Lists.prototype.ensure = function (title, description, template, enableContentTypes, additionalSettings) {
        ...
        return new Promise(function (resolve, reject) {
            var addOrUpdateSettings = (0, _common.extend)(additionalSettings, { Title: title, Description: description, ContentTypesEnabled: enableContentTypes }, true);
...
var List = /** @class */function (_super) {
    (0, _tslib.__extends)(List, _super);
    function List() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    List.prototype.getChanges = function (query) {
        return this.clone(List, "getchanges").postCore({
            body: JSON.stringify({ "query": (0, _common.extend)({ "__metadata": { "type": "SP.ChangeQuery" } }, query) })
        });
    };
    /**
    ...
    List.prototype.getItemsByCAMLQuery = function (query) {
        ...
        return q.expand.apply(q, expands).postCore({
            body: JSON.stringify({ "query": (0, _common.extend)({ "__metadata": { "type": "SP.CamlQuery" } }, query) })
        });
    };
    /**
    ...
    List.prototype.getListItemChangesSinceToken = function (query) {
        return this.clone(List, "getlistitemchangessincetoken").postCore({
            body: JSON.stringify({ "query": (0, _common.extend)({ "__metadata": { "type": "SP.ChangeLogItemQuery" } }, query) })
        }, { parse: function (r) {
                return r.text();
            } });
    };
    ...
    List.prototype.renderListDataAsStream = function (parameters, overrideParameters) {
        ...
        var postBody = {
            overrideParameters: (0, _common.extend)({
...
var Items = /** @class */function (_super) {
    (0, _tslib.__extends)(Items, _super);
    /**
    ...
    Items.prototype.getAll = function (requestSize) {
        ...
        _logging.Logger.write("Calling items.getAll should be done sparingly. Ensure this is the correct choice. If you are unsure, it is not.", 2 /* Warning */);
    ...
    Items.prototype.ensureListItemEntityTypeName = function (candidatelistItemEntityTypeFullName) {
        return candidatelistItemEntityTypeFullName ? Promise.resolve(candidatelistItemEntityTypeFullName) : this.getParent(List).getListItemEntityTypeFullName();
    };
    return Items;
}(SharePointQueryableCollection);
/**
...
var Item = /** @class */function (_super) {
    (0, _tslib.__extends)(Item, _super);
    function Item() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    Item.prototype.ensureListItemEntityTypeName = function (candidatelistItemEntityTypeFullName) {
        return candidatelistItemEntityTypeFullName ? Promise.resolve(candidatelistItemEntityTypeFullName) : this.getParent(List, this.parentUrl.substr(0, this.parentUrl.lastIndexOf("/"))).getListItemEntityTypeFullName();
    };
    return Item;
...
var ItemVersions = /** @class */function (_super) {
    (0, _tslib.__extends)(ItemVersions, _super);
    /**
...
var ItemVersion = /** @class */function (_super) {
    (0, _tslib.__extends)(ItemVersion, _super);
...
var Files = /** @class */function (_super) {
    (0, _tslib.__extends)(Files, _super);
    /**
...
var File = /** @class */function (_super) {
    (0, _tslib.__extends)(File, _super);
    function File() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ...
    File.prototype.getText = function () {
        return this.clone(File, "$value", false).get(new _odata.TextParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.getBlob = function () {
        return this.clone(File, "$value", false).get(new _odata.BlobParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getBuffer = function () {
        return this.clone(File, "$value", false).get(new _odata.BufferParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
     * Gets the contents of a file as an ArrayBuffer, works in Node.js. Not supported in batching.
     */
    File.prototype.getJSON = function () {
        return this.clone(File, "$value", false).get(new _odata.JSONParser(), { headers: { "binaryStringResponseBody": "true" } });
    };
    /**
    ...
    File.prototype.setContentChunked = function (file, progress, chunkSize) {
        ...
        var uploadId = (0, _common.getGUID)();
    ...
    File.prototype.startUpload = function (uploadId, fragment) {
        return this.clone(File, "startUpload(uploadId=guid'" + uploadId + "')", false).postCore({ body: fragment }).then(function (n) {
    ...
    File.prototype.continueUpload = function (uploadId, fileOffset, fragment) {
        return this.clone(File, "continueUpload(uploadId=guid'" + uploadId + "',fileOffset=" + fileOffset + ")", false).postCore({ body: fragment }).then(function (n) {
            // When OData=verbose the payload has the following shape:
    ...
    File.prototype.finishUpload = function (uploadId, fileOffset, fragment) {
        return this.clone(File, "finishUpload(uploadId=guid'" + uploadId + "',fileOffset=" + fileOffset + ")", false).postCore({ body: fragment }).then(function (response) {
            return {
                data: response,
...
var Versions = /** @class */function (_super) {
    (0, _tslib.__extends)(Versions, _super);
    /**
     * Creates a new instance of the File class
     *
     * @param baseUrl The url or SharePointQueryable which forms the parent of this fields collection
...
var Version = /** @class */function (_super) {
    (0, _tslib.__extends)(Version, _super);
    function Version() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
...
var AppCatalog = /** @class */function (_super) {
    (0, _tslib.__extends)(AppCatalog, _super);
...
var ClientSidePage = /** @class */function (_super) {
    (0, _tslib.__extends)(ClientSidePage, _super);
    /**
    ...
    ClientSidePage.create = function (library, pageName, title, pageLayoutType) {
        ...
        return library.rootFolder.files.select("Name").filter("Name eq '" + pageName + "'").get().then(function (fs) {
            ...
            return library.rootFolder.select("ServerRelativePath").get().then(function (path) {
                var pageServerRelPath = (0, _common.combinePaths)("/", path.ServerRelativePath.DecodedUrl, pageName);
...
var CanvasColumn = /** @class */function (_super) {
    (0, _tslib.__extends)(CanvasColumn, _super);
...
var ClientSidePart = /** @class */function (_super) {
    (0, _tslib.__extends)(ClientSidePart, _super);
...
var ClientSideWebpart = /** @class */function (_super) {
    ...
    ClientSideWebpart.prototype.setProperties = function (properties) {
        this.propertieJson = (0, _common.extend)(this.propertieJson, properties);
        return this;
    };
...
var NavigationNodes = /** @class */function (_super) {
    (0, _tslib.__extends)(NavigationNodes, _super);
...
var NavigationNode = /** @class */function (_super) {
    (0, _tslib.__extends)(NavigationNode, _super);
...
var NavigationService = /** @class */function (_super) {
    (0, _tslib.__extends)(NavigationService, _super);
...
var RegionalSettings = /** @class */function (_super) {
    (0, _tslib.__extends)(RegionalSettings, _super);
    /**
...
var InstalledLanguages = /** @class */function (_super) {
    (0, _tslib.__extends)(InstalledLanguages, _super);
...
var TimeZone = /** @class */function (_super) {
    (0, _tslib.__extends)(TimeZone, _super);
...
var TimeZones = /** @class */function (_super) {
    (0, _tslib.__extends)(TimeZones, _super);
...
var SearchQueryBuilder = /** @class */function () {
    ...
    SearchQueryBuilder.prototype.extendQuery = function (part) {
        this._query = (0, _common.extend)(this._query, part);
        return this;
    };
...
var Search = /** @class */function (_super) {
    (0, _tslib.__extends)(Search, _super);
    /**
...
var SearchResults = /** @class */function () {
    ...
    SearchResults.prototype.getPage = function (pageNumber, pageSize) {
        ...
        var query = (0, _common.extend)(this._query, {
            RowLimit: rows,
...
var SearchSuggest = /** @class */function (_super) {
    (0, _tslib.__extends)(SearchSuggest, _super);
...
var SPBatch = /** @class */function (_super) {
    ...
    SPBatch.prototype.executeImpl = function () {
        var _this = this;
        _logging.Logger.write("[" + this.batchId + "] (" + new Date().getTime() + ") Executing batch with " + this.requests.length + " requests.", 1 /* Info */);
        // if we don't have any requests, don't bother sending anything
        // this could be due to caching further upstream, or just an empty batch
        if (this.requests.length < 1) {
            _logging.Logger.write("Resolving empty batch.", 1 /* Info */);
        ...
        return toAbsoluteUrl(this.baseUrl).then(function (absoluteRequestUrl) {
            ...
            for (var i = 0; i < _this.requests.length; i++) {
                ...
                var url = (0, _common.isUrlAbsolute)(reqInfo.url) ? reqInfo.url : (0, _common.combinePaths)(absoluteRequestUrl, reqInfo.url);
                _logging.Logger.write("[" + _this.batchId + "] (" + new Date().getTime() + ") Adding request " + reqInfo.method + " " + url + " to batch.", 0 /* Verbose */);
                if (reqInfo.method !== "GET") {
            ...
            _logging.Logger.write("[" + _this.batchId + "] (" + new Date().getTime() + ") Sending batch request.", 1 /* Info */);
            return client.fetch((0, _common.combinePaths)(absoluteRequestUrl, "/_api/$batch"), batchOptions).then(function (r) {
                return r.text();
            }).then(SPBatch.ParseResponse).then(function (responses) {
                ...
                _logging.Logger.write("[" + _this.batchId + "] (" + new Date().getTime() + ") Resolving batched requests.", 1 /* Info */);
                return responses.reduce(function (chain, response, index) {
                    var request = _this.requests[index];
                    _logging.Logger.write("[" + _this.batchId + "] (" + new Date().getTime() + ") Resolving batched request " + request.method + " " + request.url + ".", 0 /* Verbose */);
...
var Features = /** @class */function (_super) {
    (0, _tslib.__extends)(Features, _super);
    /**
     * Creates a new instance of the Lists class
     *
     * @param baseUrl The url or SharePointQueryable which forms the parent of this fields collection
...
var Feature = /** @class */function (_super) {
    (0, _tslib.__extends)(Feature, _super);
    function Feature() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
...
var RelatedItemManagerImpl = /** @class */function (_super) {
    (0, _tslib.__extends)(RelatedItemManagerImpl, _super);
...
var Webs = /** @class */function (_super) {
    (0, _tslib.__extends)(Webs, _super);
    /**
...
var WebInfos = /** @class */function (_super) {
    (0, _tslib.__extends)(WebInfos, _super);
    /**
...
var Web = /** @class */function (_super) {
    ...
    */
    ...
    Web.prototype.getChanges = function (query) {
        var postBody = JSON.stringify({ "query": (0, _common.extend)({ "__metadata": { "type": "SP.ChangeQuery" } }, query) });
...
var Site = /** @class */function (_super) {
    (0, _tslib.__extends)(Site, _super);
    /**
...
var UserProfileQuery = /** @class */function (_super) {
    (0, _tslib.__extends)(UserProfileQuery, _super);
    /**
    ...
    UserProfileQuery.prototype.setMyProfilePic = function (profilePicSource) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            (0, _common.readBlobAsArrayBuffer)(profilePicSource).then(function (buffer) {
...
var SocialQuery = /** @class */function (_super) {
    (0, _tslib.__extends)(SocialQuery, _super);
    /**
...
var MySocialQuery = /** @class */function (_super) {
    (0, _tslib.__extends)(MySocialQuery, _super);
    /**
     * Creates a new instance of the SocialQuery class
     *
     * @param baseUrl The url or SharePointQueryable which forms the parent of this social query
...
var UtilityMethod = /** @class */function (_super) {
    (0, _tslib.__extends)(UtilityMethod, _super);
    /**
    ...
    UtilityMethod.prototype.sendEmail = function (props) {
        ...
        if (props.To && props.To.length > 0) {
            params.properties = (0, _common.extend)(params.properties, {
                To: { results: props.To }
            });
        }
...
},{"tslib":295,"@pnp/logging":296,"@pnp/common":297,"@pnp/odata":298}],4:[function(require,module,exports) {
"use strict";

var _sp = require("@pnp/sp");
...
(function () {
    _sp.sp.web.currentUser.get().then(function (user) {
        console.log(user);
        _sp.sp.web.siteUsers.getById(1073741823).groups.filter("LoginName eq 'TestGroup'").get().then(function (result) {

            var title = result.length > 0 ? 'TestGroup' : null;
            console.log(title);
        });
    });
})();
},{"@pnp/sp":36}],466:[function(require,module,exports) {
...
//# sourceMappingURL=/sp-grp-mem-pnp.e96b5534.map